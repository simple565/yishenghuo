    ...
    public static class HeWeather5Bean {
        ...
        public static class SuggestionBean {
            ...
            public String[] getBrf() {
                String[] brf = {comf.getBrf(), cw.getBrf(), drsg.getBrf(), flu.getBrf(), sport.getBrf(),
                        trav.getBrf(), uv.getBrf()};
                return brf;
            }

            public String[] getDetail() {
                String[] detail = {
                        comf.getTxt(), cw.getTxt(), drsg.getTxt(), flu.getTxt(), sport.getTxt(),
                        trav.getTxt(), uv.getTxt()};
                return detail;
            }
