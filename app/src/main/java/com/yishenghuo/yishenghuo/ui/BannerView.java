...
import com.yishenghuo.yishenghuo.adapter.BannerAdapter;
...
//                sendEmptyMessageDelayed(MSG_LOOP, LOOP_INTERVAL);
    ...
    private void initLinearPosition() {
        ...
        layoutParams.bottomMargin = getResources().getDimensionPixelSize(R.dimen.dot_paddingbottom);
        mLinearPosition.setPadding(getResources().getDimensionPixelSize(R.dimen.dot_horizontal_margin), 0, 0, 0);
        ...
        if (viewList != null && viewList.size() != 0) {
                ...
                for (int i = 0; i < diffCnt; i++) {
                    if (needAdd) {
                        ...
                        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                                ViewGroup.LayoutParams.WRAP_CONTENT);
                        layoutParams.rightMargin = getResources().getDimensionPixelOffset(R.dimen.dot_horizontal_margin);
                        img.setLayoutParams(layoutParams);
                        img.setBackgroundResource(R.drawable.dot_not_select);
            ...
            for (int i = 0; i < mLinearPosition.getChildCount(); i++) {
                if (i == (curPos % viewSize)) {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.dot_selected);
                } else {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.dot_not_select);
                }
            }
        }
    }
