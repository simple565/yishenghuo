...
import com.maureen.yishenghuo.adapter.DayForecastAdapter;
import com.maureen.yishenghuo.adapter.SuggestionsListAdapter;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void getWeather() {
        ...
        final String city = "集美";//LocationUtil.getLocation(this);
